...
(function () {
  ...
  function renderDato() {
    ...
    wrap.innerHTML = `
      ...
      <div class="klai-powered">Drevet af <strong>KlarAI</strong></div>
    `;
  }
  ...
  function renderBekraeftet() {
    ...
    wrap.innerHTML = `
      ...
      <div class="klai-powered" style="margin-top:1.25rem">Drevet af <strong>KlarAI</strong></div>
    `;
  }
